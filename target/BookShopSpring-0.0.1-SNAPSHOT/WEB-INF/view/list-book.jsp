        ...
        <jsp:include page="header.jsp"></jsp:include>
            ...
            <div class="container-fluid pt-5">
                ...
                <div class="row px-xl-5 pb-3">
                    ...
                    <c:url var="linkImage" value="/resources/img/${tempBook.image}">
					</c:url>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                        <div class="card product-item border-1 mb-4">
                            ...
                            <div class="card-footer d-flex justify-content-between bg-light border-1">
                                <a href="${pageContext.request.contextPath}/books/${tempBook.id}" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</a>
                                <a href="${pageContext.request.contextPath}/cart/addToCart?id=${tempBook.id}" class="btn btn-sm text-dark p-0"><i class="fas fa-shopping-cart text-primary mr-1"></i>Add To Cart</a>
                            </div>
                        </div>
                    </div>
                    </c:forEach>
